...
function FeaturedBroadcast({ stream, currentUser, router }) {
  ...
  return (
    <div
      ...
      className="w-full aspect-video md:aspect-[21/9] bg-zinc-900 rounded-3xl overflow-hidden relative border border-zinc-800 shadow-2xl group cursor-pointer"
    >
...
function StreamCard({ stream, onClick }) {
  return (
    <div
      onClick={onClick}
      className="bg-zinc-900/70 border border-zinc-800 hover:border-amber-500/50 rounded-2xl overflow-hidden transition-all group cursor-pointer shadow-xl"
    >
